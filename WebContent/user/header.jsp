			...
			<div class="row">
			    ...
			    <div class="col-sm-3 col-md-3 col-xs-12 hidden-xs">
					...
					<style>
						...
						<button type="button" class="btn btn-default btn-lg" Width="100%"onclick="location.href='<%=request.getContextPath()%>/user/managerlogin.jsp'">Manager Login</button>
						    <div class="divider"/>
						<button type="button" class="btn btn-primary btn-lg" Width="100%"onclick="location.href='<%=request.getContextPath()%>/user/employeelogin.jsp'">Employee Login</button>
					</div>
					<!-- button-login end here -->
				</div>
			</div>
